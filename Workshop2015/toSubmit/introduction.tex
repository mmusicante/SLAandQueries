...
The MOOC  aims at being privacy respectful of the producers and consumers participating in courses.
 ...
 We have proposed such architecture in \cite{ghediraetal2014}. With this architecture it is necessary to revisit the specification of the integration phases in order to show how to include QoS and SLA and thereby proposing a new way of dealing with a data production and consumption process. 
