...
\begin{trivlist}\sf\footnotesize
\item[~-~e$_i$:]estim-cost$_i$(contents, req\_size, cost, prov\_size, loc), QoS preferences$_\mathit{user}$.
...
{QoS preferences}$_\mathit{user}$ is the user's proposal to the contents provider. 
