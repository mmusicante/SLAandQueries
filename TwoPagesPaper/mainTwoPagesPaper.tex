...
The white classes are an abstract representation of SLA content. %necessary to describe our extension. 
...
The integrated SLA concepts can be reused for evaluating other  queries using  the same concepts. This enables the use of previous compositions that  met the requirements of the user  and an SLA.
\begin{figure}[!t]
\centering
